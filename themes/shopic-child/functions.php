...
// ====================================================================
// API Registrations - Now handled in bootstrap files
// These old registrations are kept commented for reference
// ====================================================================
// OLD Advertisement API - now in bootstrap/advertisement.php
...
// OLD Products API - now in bootstrap/product.php
// add_action("rest_api_init", "get_products_api");

// OLD Mixed API - now in bootstrap/mixed.php
...
{
	register_rest_route("api/v1", "advertisement/create", array(
		'methods' => WP_REST_Server::CREATABLE,  
		'callback' => "create_ad",
	));
}
...
{
	register_rest_route("api/v1", "advertisement/update", array(
...
{
	register_rest_route("api/v1", "advertisement/delete", array(
...
{
	register_rest_route("api/v1", "advertisement/read/single", array(
		'methods' => WP_REST_Server::READABLE,  
...
{
	register_rest_route("api/v1", "advertisement/read/user", array(
		'methods' => WP_REST_Server::READABLE,  
...
{
	register_rest_route("api/v1", "advertisement/read/all", array(
		'methods' => WP_REST_Server::READABLE,  
...
{
	register_rest_route("api/v1", "advertisement/read/mix", array(
		'methods' => WP_REST_Server::READABLE,  
