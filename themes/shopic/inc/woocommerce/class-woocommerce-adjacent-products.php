<?php
/**
 * Shopic WooCommerce Adjacent Products Class
 *
 * @package  shopic
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Shopic_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Shopic WooCommerce Adjacent Products Class
	 */
	class Shopic_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'shopic_woocommerce_adjacent_query_args', $args ) );
