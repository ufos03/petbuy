<?php
/**
 * Shopic_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Shopic_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Shopic_Product_Brand_List_Walker', false)) :

	class Shopic_Product_Brand_List_Walker extends Walker {
