...
class Shopic_Call_To_Action extends Elementor\Widget_Base {

    public function get_name() {
        return 'shopic-banner';
    }

    public function get_title() {
        return esc_html__( 'Shopic Banner', 'shopic' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Image Resolution', 'shopic' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => esc_html__( 'Graphic Element', 'shopic' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'shopic' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'shopic' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'shopic' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default' => esc_html__( 'Default', 'shopic' ),
                    'stacked' => esc_html__( 'Stacked', 'shopic' ),
                    'framed' => esc_html__( 'Framed', 'shopic' ),
                ],
                'default' => 'default',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Shape', 'shopic' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => esc_html__( 'Circle', 'shopic' ),
                    'square' => esc_html__( 'Square', 'shopic' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            'subtitle',
            [
                'label' => esc_html__( 'Sub title', 'shopic' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the sub title', 'shopic' ),
                'placeholder' => esc_html__( 'Enter your sub title', 'shopic' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => esc_html__( 'Title & Description', 'shopic' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the heading', 'shopic' ),
                'placeholder' => esc_html__( 'Enter your title', 'shopic' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'shopic' ),
                'placeholder' => esc_html__( 'Enter your description', 'shopic' ),
                'separator' => 'none',
                'rows' => 5,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => esc_html__( 'Title HTML Tag', 'shopic' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click Here', 'shopic' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'link_click',
            [
                'label' => esc_html__( 'Apply Link On', 'shopic' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => esc_html__( 'Whole Box', 'shopic' ),
                    'button' => esc_html__( 'Button Only', 'shopic' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label' => esc_html__( 'Stretch', 'shopic' ),
        ...
        $this->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'shopic' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
                    ...
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'shopic' ),
        ...
        $this->add_control(
            'show_bg',
            [
                'label'     => esc_html__( 'Show Bg gradien', 'shopic' ),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            'graphic_image_hover',
            [
                'label' => esc_html__( 'Image Effect', 'shopic' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secondary Color', 'shopic' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_size',
            [
                'label' => esc_html__( 'Icon Size', 'shopic' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 6,
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Icon Padding', 'shopic' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'title_decor_size',
            [
                'label' => esc_html__( 'Decor Size', 'shopic' ),
                'type' => Controls_Manager::SLIDER,
                'size_units'    => ['%'],
                'range' => [
                    '%' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .elementor-shopic-banner:hover .elementor-cta__title:before'  => 'height: {{SIZE}}% !important;'
                ],
                'condition' => [
                    'title_decor!'  => ''
                ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Decor Position', 'shopic' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min'   => 0,
                ...
                'size_units'    => ['px'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-shopic-banner .elementor-cta__title:before'  => 'top: {{SIZE}}{{UNIT}}'
                ],
                'condition' => [
                    'title_decor!'  => ''
                ]
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Subtitle', 'shopic' ),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Colors', 'shopic' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => esc_html__( 'Sub title Color', 'shopic' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => esc_html__( 'Description Color', 'shopic' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__( 'Hover Effects', 'shopic' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'content_animation',
            [
                'label' => esc_html__( 'Hover Animation', 'shopic' ),
                'type' => Controls_Manager::SELECT,
                'groups' => [
                    [
                        'label' => esc_html__( 'None', 'shopic' ),
                        'options' => [
                            '' => esc_html__( 'None', 'shopic' ),
                        ],
                    ],
                    [
                        'label' => esc_html__( 'Entrance', 'shopic' ),
                        'options' => [
                    ...
                    [
                        'label' => esc_html__( 'Reaction', 'shopic' ),
                        'options' => [
                            'grow' => 'Grow',
                            'shrink' => 'Shrink',
        ...
        $this->add_control(
            'animation_class',
            [
                'label' => esc_html__( 'Animation', 'shopic' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Animation Duration', 'shopic' ) . ' (ms)',
                'type' => Controls_Manager::SLIDER,
        ...
        $this->add_control(
            'sequenced_animation',
            [
                'label' => esc_html__( 'Sequenced Animation', 'shopic' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'On', 'shopic' ),
                'label_off' => esc_html__( 'Off', 'shopic' ),
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'shopic' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'overlay_blend_mode',
            [
                'label' => esc_html__( 'Blend Mode', 'shopic' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'Normal', 'shopic' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
        ...
        $this->add_control(
            'effect_duration',
            [
                'label' => esc_html__( 'Transition Duration', 'shopic' ),
                'type' => Controls_Manager::SLIDER,
                'render_type' => 'template',
                'default' => [
                    'size' => 1500,
    ...
    protected function render() {
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . shopic_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-shopic-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo shopic_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo shopic_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo shopic_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo shopic_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo shopic_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <?php printf('%s', $settings['subtitle']); ?>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . shopic_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo shopic_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . shopic_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
...
$widgets_manager->register(new Shopic_Call_To_Action());
