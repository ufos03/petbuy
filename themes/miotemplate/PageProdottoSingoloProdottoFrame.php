...
/*
*
* Template Name: Prodotto Singolo Prodotto Frame
...
<div class="container tra-menu-e-titolo d-none d-md-block">
    ...
    <div class="position-relative">
        ...
        <div class="">
            <div class="">
                <img src="<?php echo get_template_directory_uri() . '/ufficiale/osso-nome-negozio-prodotto.svg'; ?>" class="" style="width: 100%; height: auto;" alt=""/>
            </div>
        </div>
    </div>
    ...
    <div class="mt-4 position-relative">
        ...
        <div style="position: absolute; bottom: 163px; right: -25px; z-index: -1; display: flex;">
            <img src="<?php echo get_template_directory_uri() . '/ufficiale/impronta2-basso-destra-gallery.svg'; ?>" class="" alt="Immagine Basso Destra 2">
		  	...
		  	<div class="col-md-6 col-md-6-img pe-0 ps-4 d-flex flex-column position-relative">
			  <div class="immagine-sfondo immagine-sfondo-alto">
				...
				<!--desktop-->
			  <div class="check-conteggio nascondi-su-tablet" data-price="39.99">
				<div class="row align-items-start">
				  <div class="col-md-6">
					...
					<div class="acapo" style="font-size:23px;">
				  		<div>
					  		<span class="check-item-price">$39.99</span>
				...
				<div class="d-flex align-items-center p-conta-prodotto-frame" style="height: 60px;">
					<div class="conteggio-numero d-flex align-items-center justify-content-center h-100 flex-grow-1">
						<button class="quantity-button check-decrement btn btn-sm">-</button>
						<input type="text" class="check-quantity-input form-control form-control-sm mx-2 text-center" value="1" min="1" style="width: 50px;">
						<button class="quantity-button check-increment btn btn-sm">+</button>
					</div>

					<a href="#" style="color:#F87537!important;border-color:#F87537;border-style: solid; height: 100%;" class="btn noacapo bg-trasparente border-3 ms-3 fw-bold fs-5 d-flex align-items-center justify-content-center flex-grow-1" role="button">
						<img src="<?php echo get_template_directory_uri() . '/ufficiale/shopping-cart-arancione.svg'; ?>" class="me-2" alt=""/>Aggiungi al carrello
					</a>

					<div class="check-item-price d-none">$39.99</div>

					<a href="#" style="height: 100%;" class="btn btn-warning noacapo ms-3 d-flex align-items-center justify-content-center flex-grow-1 fs-5" role="button">Acquista</a>
				</div>

				<hr class="m-conta-prodotto-frame">

				<div class="spaz-guarantee">
					<div class="d-flex align-items-center mb-2">
						<img src="<?php echo get_template_directory_uri() . '/ufficiale/corriere.svg'; ?>" alt="Immagine" class="me-2"> <div class="small"><span class="fw-bold">Data di arrivo:</span> <span class="text-secondary">Giugno 30 - Agosto 03</span></div>
					</div>

					<div class="d-flex align-items-center">
						<img src="<?php echo get_template_directory_uri() . '/ufficiale/pacco.svg'; ?>" alt="Immagine" class="me-2"> <div class="small"><span class="fw-bold">Tempo di rimborso:</span> <span class="text-secondary">Giugno 30 - Agosto 03</span></div>
					</div>
				</div>
				...
				<!--tablet-->
				<div class="check-conteggio nascondi-su-desktop" style="margin-top:-730px;" data-price="39.99">
				<div class="row align-items-start">
				  <div class="col-md-6">
						<div class="noacapo">
						  <h1>Ciotola per cani</h1>
				...
				<div class="d-flex align-items-center flex-wrap" style="height: 60px;">
				    <div class="d-flex align-items-center flex-grow-1">
				        <div class="conteggio-numero d-flex align-items-center justify-content-center h-100 flex-grow-1" style="height:60px!important;">
				            <button class="quantity-button check-decrement btn btn-sm">-</button>
				            <input type="text" class="check-quantity-input form-control form-control-sm mx-2 text-center" value="1" min="1" style="width: 50px;">
				            <button class="quantity-button check-increment btn btn-sm">+</button>
				        </div>

				        <a href="#" style="color:#F87537!important;border-color:#F87537;border-style: solid; height:60px;" class="btn noacapo bg-trasparente border-3 ms-3 fw-bold fortablet d-flex align-items-center justify-content-center flex-grow-1" role="button">
				            <img src="<?php echo get_template_directory_uri() . '/ufficiale/shopping-cart-arancione.svg'; ?>" class="me-2" alt=""/>Aggiungi al carrello
				        </a>
				    </div>
				    ...
				    <a href="#" class="btn btn-warning noacapo mt-3 d-flex align-items-center justify-content-center fs-5 flex-grow-1 w-100 w-lg-auto" style="height:60px;" role="button">Acquista</a>
				</div>
	...
	<div class="d-block d-sm-none mt-4">
		...
		<div class="container">
			<div class="row">
				<img src="<?php echo get_template_directory_uri() . '/ufficiale/img-principale-prodotto-prodotto.svg'; ?>" alt="Immagine principale">
			</div>
		...
		<div class="container position-relative check-conteggio-mobile" data-price="39.99">
			...
			<div class="acapo" style="font-size:23px;">
					<div>
						<span class="check-item-price-mobile">$39.99</span>
						<span class="text-secondary text-decoration-line-through" style="font-size:20px;">$59.00</span>
					</div>
			</div>
			...
			<div class="" style="height: 60px;">
				<div class="conteggio-numero w-100 h-100">
					<button class="quantity-button check-decrement-mobile">-</button>
					<input type="text" class="check-quantity-input-mobile" value="1" min="1" style="width: 50px;">
					<button class="quantity-button check-increment-mobile">+</button>
				</div>

				<a href="#" style="color:#F87537!important;border-color:#F87537;border-style: solid; height: 100%;" class="btn noacapo bg-trasparente border-2 fw-bold fs-5 d-flex align-items-center justify-content-center flex-grow-1 mt-4" role="button">
					<img src="<?php echo get_template_directory_uri() . '/ufficiale/shopping-cart-arancione.svg'; ?>" class="me-2" alt=""/>Aggiungi al carrello
				</a>

				<div class="check-item-price-mobile d-none">$39.99</div>

				<a href="#" style="height: 100%;" class="btn btn-warning noacapo d-flex align-items-center justify-content-center flex-grow-1 fs-5 mt-4" role="button">Acquista</a>
			</div>
