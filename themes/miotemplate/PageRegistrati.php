        ...
        <div class="row flex-grow-1 sfondo-sx p-4">
            <div class="col-5 col-left ">
                <div class="content-wrapper">
                    ...
                    <div class="fw-bold fs-5" style="margin-bottom:40px;">Crea il tuo account</div>

                    		<div class="" style="margin-bottom:20px;">
          						<input type="text" class="form-control edit-form-header px-3 border" style="background-color:#f3f9fa;" id="" placeholder="Inserisci nome">
          					</div>

                    		<div class="" style="margin-bottom:20px;">
          						<input type="text" class="form-control edit-form-header px-3 border" style="background-color:#f3f9fa;" id="" placeholder="Inserisci cognome">
          					</div>
                    ...
                    <div class="d-flex justify-content-between small">
                          ...
                          <div class="form-check form-switch category-item">
                            ...
                            <label class="form-check-label ms-2 noacapo fortablet2" for="flexSwitchCheckDefault">Ricordati di me</label>
          						...
          						<div class="col-md-6">
          							<!--
          							<div class="float-end">
          								<a href="#" style="color:#f87537;">Forgot password?</a>
          							</div>
          							-->
          						</div>
                     ...
                     <a href="#" style="width:100%;margin:20px 0px 0px 0px;" class="btn btn-warning noacapo" role="button">Registrati ora</a>
                      ...
                      <a href="#" style="width:100%;background-color:#f3f9fa;margin-bottom:10px;" class="btn mb-4 login-con-social" role="button"><img src="<?php echo get_template_directory_uri() . '/ufficiale/facebook-login.svg'; ?>" class="me-2 py-1" alt=""/>Login con Facebook</a>
