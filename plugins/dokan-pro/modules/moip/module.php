...
class Module {
    ...
    public function init_filters() {
        ...
        add_filter( 'dokan_admin_notices', array( $this, 'display_notice' ) );
    }

    /**
     * Display notice for Moip deprication.
     *
     * @param array $notices
     *
     * @return array
     */
    public function display_notice( $notices ): array {
        $notices[] = array(
            'type'        => 'alert',
            'title'       => esc_html__( 'Wirecard Deprecation Notice', 'dokan' ),
            'description' => esc_html__( 'The Wirecard payment gateway is deprecated and will be removed in future versions. Please consider using an alternative payment gateway.', 'dokan' ),
            'priority'    => 9,
            'scope'       => 'global',
        );
